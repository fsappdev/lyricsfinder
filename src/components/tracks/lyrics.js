...
class Lyrics extends Component {
   ...
   render() {
      ...
      if (track === undefined || lyrics === undefined || Object.keys(track).length === 0 || Object.keys(lyrics).length === 0) {
         ...
         return (
            <React.Fragment>
               <Link to="/" className="btn btn-dark btn-sm mb-4">Volver</Link>
               <div className="card">
               ...
               <ul className="list-group mt-3">
                  ...
                  <li className="list-group-item">
                     <strong>Song Genre
                     </strong>: {track.primary_genres.music_genre_list.length === 0 ? 'NO GENRE AVAILABLE' : track.primary_genres.music_genre_list[0].music_genre.music_genre_name}
                  </li>
                  <li className="list-group-item">
